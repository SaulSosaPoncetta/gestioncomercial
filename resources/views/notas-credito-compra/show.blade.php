...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0"><i class="bi bi-arrow-return-right me-2"></i>Nota de Crédito {{ $nota->numero_nota }}</h3>
    <a href="{{ route('notas-credito-compra.index') }}" class="btn btn-outline-secondary">
...
<div class="row g-3 mb-3">
    <div class="col-md-4">
        <div class="card shadow-sm h-100">
            <div class="card-body">
                <div class="text-muted small">Compra Original</div>
                <div class="fw-semibold"><a href="{{ route('compras.show', $nota->id_compra) }}">Compra #{{ $nota->id_compra }}</a></div>
                <div class="text-muted small mt-2">Proveedor</div>
                <div>{{ $nota->compra->proveedor->razon_social_nombre ?? '—' }}</div>
            </div>
        </div>
    </div>
    <div class="col-md-4">
