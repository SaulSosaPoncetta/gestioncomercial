...
<head>
    ...
    <style>
        ...
        .main-content { flex: 1; min-height: 100vh; background: #f4f6f8; min-width: 0; }
    </style>
</head>
<body>
    <div id="app" class="d-flex">
        <nav class="sidebar d-flex flex-column p-2" id="sidebar">
            ...
            <a class="nav-link {{ request()->is('home') ? 'active' : '' }}" href="{{ route('dashboard') }}" title="Dashboard">
            ...
            <a class="nav-link {{ request()->is('categorias*') ? 'active' : '' }}" href="{{ route('categorias.index') }}" title="Categorías">
            ...
            <a class="nav-link {{ request()->is('productos*') ? 'active' : '' }}" href="{{ route('productos.index') }}" title="Productos">
                <i class="bi bi-box-seam"></i><span class="link-label ms-2">Productos</span>
            </a>
            @endif
            @if(Route::has('listas-precios.index'))
            <a class="nav-link {{ request()->is('listas-precios*') ? 'active' : '' }}" href="{{ route('listas-precios.index') }}" title="Listas de Precios">
            ...
            <a class="nav-link {{ request()->is('personas*') ? 'active' : '' }}" href="{{ route('personas.index') }}" title="Clientes / Proveedores">
            ...
            <a class="nav-link {{ request()->is('almacenes*') ? 'active' : '' }}" href="{{ route('almacenes.index') }}" title="Almacenes">
                <i class="bi bi-building"></i><span class="link-label ms-2">Almacenes</span>
            </a>
            @endif
            @if(Route::has('stock.index'))
            <a class="nav-link {{ request()->is('stock*') ? 'active' : '' }}" href="{{ route('stock.index') }}" title="Stock">
            ...
            <a class="nav-link {{ request()->is('compras*') ? 'active' : '' }}" href="{{ route('compras.index') }}" title="Compras">
                <i class="bi bi-cart-plus"></i><span class="link-label ms-2">Compras</span>
            </a>
            @endif
            @if(Route::has('ventas.index'))
            <a class="nav-link {{ request()->is('ventas*') ? 'active' : '' }}" href="{{ route('ventas.index') }}" title="Ventas">
                <i class="bi bi-cart-check"></i><span class="link-label ms-2">Ventas</span>
            </a>
            @endif
            @if(Route::has('cajas.index'))
            <a class="nav-link {{ request()->is('cajas*') ? 'active' : '' }}" href="{{ route('cajas.index') }}" title="Cajas">
                <i class="bi bi-cash-stack"></i><span class="link-label ms-2">Cajas</span>
            </a>
            @endif
            @if(Route::has('cuentas-por-cobrar.index'))
            <a class="nav-link {{ request()->is('cuentas-por-cobrar*') ? 'active' : '' }}" href="{{ route('cuentas-por-cobrar.index') }}" title="Cuentas por Cobrar">
                <i class="bi bi-cash"></i><span class="link-label ms-2">Cuentas por Cobrar</span>
            </a>
            @endif
            @if(Route::has('cuentas-por-pagar.index'))
            <a class="nav-link {{ request()->is('cuentas-por-pagar*') ? 'active' : '' }}" href="{{ route('cuentas-por-pagar.index') }}" title="Cuentas por Pagar">
            ...
            <a class="nav-link {{ request()->is('empresas*') ? 'active' : '' }}" href="{{ route('empresas.index') }}" title="Empresas">
                <i class="bi bi-building-gear"></i><span class="link-label ms-2">Empresas</span>
            </a>
            @endif
            @if(Route::has('sucursales.index'))
            <a class="nav-link {{ request()->is('sucursales*') ? 'active' : '' }}" href="{{ route('sucursales.index') }}" title="Sucursales">
                <i class="bi bi-geo-alt"></i><span class="link-label ms-2">Sucursales</span>
            </a>
            @endif
            @if(Route::has('impuestos.index'))
            <a class="nav-link {{ request()->is('impuestos*') ? 'active' : '' }}" href="{{ route('impuestos.index') }}" title="Impuestos">
                <i class="bi bi-percent"></i><span class="link-label ms-2">Impuestos</span>
            </a>
            @endif
            @if(Route::has('monedas.index'))
            <a class="nav-link {{ request()->is('monedas*') ? 'active' : '' }}" href="{{ route('monedas.index') }}" title="Monedas">
            ...
            <div class="mt-auto">
                <a class="nav-link" href="{{ route('logout') }}" title="Salir"
                   onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <i class="bi bi-box-arrow-left"></i><span class="link-label ms-2">Salir ({{ Auth::user()->name ?? '' }})</span>
                </a>
