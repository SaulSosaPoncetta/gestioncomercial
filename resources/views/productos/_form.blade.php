...
<div class="row g-3">
    ...
    <div class="col-md-4">
        ...
        @error('id_impuesto') <div class="invalid-feedback">{{ $message }}</div> @enderror
    </div>
    ...
    <div class="col-md-3">
        ...
        @error('precio_costo') <div class="invalid-feedback">{{ $message }}</div> @enderror
    </div>
    ...
    <div class="col-md-6">
        <div class="form-check form-switch mt-2">
            <input type="checkbox" class="form-check-input" id="aplica_inventario" name="aplica_inventario" value="1"
                {{ old('aplica_inventario', $producto->aplica_inventario ?? true) ? 'checked' : '' }}>
